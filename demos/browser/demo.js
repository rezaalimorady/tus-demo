...
function startUpload() {
  ...
  const options = {
    ...
    parallelUploads,
    headers: {"Authorization": "eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiSm9obiBEb2UiLCJleHAiOjE5MDE4MDUzMzJ9.Z3nu0OXMBCnKutVXEbPDBpvyARpmL2ytgHCIYpNVYQhBxo2TR_AVNpvs7Jfw89Do6UARrij9paYi__T1Wbz3nQ"},
    metadata: {
      filename: file.name,
      filetype: file.type,
    },
